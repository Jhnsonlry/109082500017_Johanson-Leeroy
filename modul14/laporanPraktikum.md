...
##### Output 
![Screenshot Output Unguided 1_14](https://github.com/Jhnsonlry/109082500017_Johanson-Leeroy/blob/main/modul12/output/output-soal1.png)
...
##### Output 
![Screenshot Output Unguided 2_14](https://github.com/Jhnsonlry/109082500017_Johanson-Leeroy/blob/main/modul12/output/output-soal2.png)
...
##### Output 
![Screenshot Output Unguided 3_14](https://github.com/Jhnsonlry/109082500017_Johanson-Leeroy/blob/main/modul12/output/output-soal3.png)
[Program di atas dibuat untuk menyimpan sekumpulan bilangan dan menampilkan nilai median dari data yang telah dimasukkan setiap kali pengguna memberikan perintah tertentu. Paling pertama merupakan deklarasi konstanta NMAX yang digunakan untuk menentukan kapasitas maksimum array yang dapat menyimpan data bilangan. Kedua adalah function insertionSort yang digunakan untuk mengurutkan elemen-elemen array menggunakan algoritma Insertion Sort secara menaik (ascending). Function ini bekerja dengan mengambil satu elemen, kemudian membandingkannya dengan elemen-elemen sebelumnya dan menggesernya ke posisi yang sesuai hingga urutan data menjadi teratur. Proses tersebut dilakukan menggunakan struktur kontrol perulangan bersarang (for). Ketiga adalah function median yang digunakan untuk menghitung nilai median dari array yang telah terurut. Function ini menggunakan struktur kontrol if-else untuk membedakan jumlah data ganjil dan genap. Jika jumlah data ganjil, median diambil dari elemen yang berada tepat di tengah array. Jika jumlah data genap, median dihitung sebagai rata-rata dari dua elemen yang berada di tengah array. Terakhir merupakan function main yang berisi deklarasi array penyimpanan data, variabel penghitung jumlah data, dan variabel input. Program menggunakan struktur kontrol perulangan tak hingga (for) untuk menerima bilangan dari user secara terus-menerus. Jika input bernilai -5313, program akan berhenti. Jika input bernilai 0, program akan melakukan pemanggilan function insertionSort untuk mengurutkan data yang telah tersimpan, kemudian memanggil function median untuk menghitung dan menampilkan nilai median. Selain itu, jika input berupa bilangan selain 0 dan -5313, bilangan tersebut akan disimpan ke dalam array dan jumlah data akan ditambah satu. Dengan demikian, program dapat menerima data secara bertahap dan menampilkan median dari seluruh data yang telah dimasukkan setiap kali pengguna memasukkan angka 0.]
...
##### Output 
![Screenshot Output Unguided 4_14](https://github.com/Jhnsonlry/109082500017_Johanson-Leeroy/blob/main/modul12/output/output-soal3.png)
...
### 5. [Sebuah program perpustakaan digunakan untuk mengelola data buku di dalam suatu perpustakaan.]
...
##### Output 
![Screenshot Output Unguided 5_14]()
